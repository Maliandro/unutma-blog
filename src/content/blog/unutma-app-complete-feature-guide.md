---
title: "Inside Unutma: A Complete Guide to Every Feature (and Why It Exists)"
description: "From quick actions and lists to vault, money tracking, and journal — how Unutma is organized, what each area does, and how to build a calmer routine around it."
pubDate: 2026-03-29
...
1. **Todo** — tasks with priorities, due ideas, and the kind of flow you expect from a serious task list (including archive and richer views on larger screens).
2. **Shopping** — a focused list for the store so “buy milk” does not drown in work tasks.
3. **Wishlist** — things you want later, separate from urgent todos.
...
1. **Day 1–2:** Set up **Actions** (a few buttons) + **one** list (todo or shopping).
2. **Day 3–4:** Add **Vault** entries you actually use weekly.
