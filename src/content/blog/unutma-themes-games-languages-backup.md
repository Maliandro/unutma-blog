...
1. Confirm **language** and **theme** still match your life.
2. Check **notification** defaults — silence what became noise.
3. Verify **backup** destinations still exist (folder not deleted, cloud account active).
